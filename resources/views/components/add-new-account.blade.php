<div id="add-new-account" class="content-body" style="display:none">
            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-xl-8 col-md-7">
                    <div class="card">
                        ...
                        <div class="card-body add-bank-card">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="javascript:void(0)" class="d-block btn-tab" data-target="add-bank">
                                        <div class="add-bank-card-content">
